 ...
 */
public final class Compiler implements MetaData {
     ...
     * @param vendor the compiler vendor.
     * @param versionMajor the major version of the compiler.
     * @param versionMinor the minor version of the compiler.
     * @param versionBuild the build version of the compiler.
     */
    public Compiler(String name, String vendor, Integer versionMajor, Integer versionMinor, Integer versionBuild) {
        this.name = name;
        this.vendor = vendor;
     ...
     * this compiler.
     */
    public Compiler(Map<String, Object> valueMap) {
        this(
    ...
    public int hashCode() {
        ...
        hash = 41 * hash + Objects.hashCode(this.versionMajor);
        hash = 41 * hash + Objects.hashCode(this.versionMinor);
        hash = 41 * hash + Objects.hashCode(this.versionBuild);
        return hash;
    }
